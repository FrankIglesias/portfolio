	...
	return (
		<div className="flex flex-col h-full justify-center gap-3">
			<div className="max-w-4xl">
				<h1 className="font-bebas text-[60px] leading-15.5">Frontend Army Podcast</h1>
				<p className="text-lg leading-relaxed max-w-3xl">
					Frontend Army is a community-driven podcast made by frontenders for frontenders. It exists
					to share practical frontend knowledge, bring real experiences from the field, and help
					developers keep growing through conversations, interviews, and community exchange.
				</p>
			</div>
